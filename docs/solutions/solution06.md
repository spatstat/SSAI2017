...
1.  Plot the estimate of *K*(*r*) against *r*
...
1.  Plot the estimate of *K*(*r*)−*π**r*<sup>2</sup> against *r*.
...
1.  Calculate the estimate of the *L*-function and plot it against *r*.
...
1.  Plot the estimate of *L*(*r*)−*r* against *r*.
...
1.  Calculate and plot an estimate of the pair correlation function using `pcf`.
...
1.  Draw tentative conclusions from these plots about interpoint interaction in the data.
...
1.  What can you interpret from these plots?

The leftmost plot is somewhat misleading as the limiting observation window come into play. That the density taper off here is effectively an edge effect. Looking at the rightmost plot, we see a slight dip in density of points near the center. This again indicate a regular point pattern, however, the data is somewhat sparse in the latter plot.
...
1.  Fit a parametric trend to the data, and use this to compute the inhomogeneous *K* function:
...
1.  Plot corresponding estimates of the inhomogeneous *L* function, using either `Linhom` or
...
1.  Draw tentative conclusions about interpoint interaction.
...
1.  Plot the *K*-function or *L*-function. It will most likely appear to show evidence of clustering.
...
1.  Generate a simulated realisation of the cell process with a 10x10 grid of cells and plot it.
